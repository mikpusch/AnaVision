...
void AreaObject::DrawObject(CDC * pDC, CRect & DrawRect){
	switch (ObjectType){
		case 0 : DrawRectangle(pDC, DrawRect); break;// Rectangle
		case 1 : DrawConus(pDC, DrawRect); break;// Conus
		default :  DrawRectangle(pDC, DrawRect); break;// Rectangle;
	}
}

void AreaObject::DrawRectangle(CDC * pDC, CRect & DrawRect){
...
void AreaObject::DrawConus(CDC * pDC, CRect & DrawRect){
	AdjustConusIndexes();
...
void AreaObject::RotatePoint(int index, CPoint newpos){
	...
	switch (ObjectType){
		case 0 : RotateRectangle(index, newpos); break;// Rectangle
		case 1 : RotateConus(index, newpos); break;// Conus
		default :  RotateRectangle(index, newpos); break;// Rectangle;
	}
